...
test('Flush Course, Group, and User DBs', async () => {
...
test('getRegisteredCourses for User should update User and Course DBs correctly', async () => {
  ...
  //   }
    ...
    // expect(CPEN321.times[1].minuteStart).toEqual(cpen321ExpectedTimes2.minuteStart);
    // expect(CPEN321.times[1].hourEnd).toEqual(cpen321ExpectedTimes2.hourEnd);
    // expect(CPEN321.times[1].minuteEnd).toEqual(cpen321ExpectedTimes2.minuteEnd);
  ...
  //   }
    ...
    // expect(CPEN331.times[1].hourStart).toEqual(cpen331ExpectedTimes2.hourStart);
    // expect(CPEN331.times[1].minuteStart).toEqual(cpen331ExpectedTimes2.minuteStart);
    // expect(CPEN331.times[1].hourEnd).toEqual(cpen331ExpectedTimes2.hourEnd);
    // expect(CPEN331.times[1].minuteEnd).toEqual(cpen331ExpectedTimes2.minuteEnd);
